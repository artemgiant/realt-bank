...
class CompanySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $company = Company::updateOrCreate(
            ...
            [
                ...
                'description_translations' => [
                    'ru' => "FAKTOR — агентство нерухомості, яке будує свою роботу на головному: довірі, результаті та повазі до кожного клієнта. Ми допомагаємо купити, продати та орендувати нерухомість — швидко, безпечно та вигідно.\r\nНаша команда складається з досвідчених рієлторів, які досконало знають ринок і щиро зацікавлені в тому, щоб ви отримали найкраще рішення. Ми не нав'язуємо — ми радимо. Ми не поспішаємо — ми діємо точно.\r\nЧому клієнти обирають FAKTOR:\r\n\r\nДосвід і експертиза. Роки роботи на ринку нерухомості, сотні успішно закритих угод та глибоке розуміння того, як влаштований ринок зсередини.\r\nПовний супровід угоди. Від першої консультації до отримання ключів — ми поруч на кожному етапі та беремо на себе всі організаційні та юридичні питання.\r\nЧесні умови. Ніяких прихованих платежів і неприємних сюрпризів. Усі умови співпраці — відкрито та зрозуміло з першого дня.\r\nАктуальна база об'єктів. Ми постійно оновлюємо пропозиції та першими дізнаємося про найцікавіші варіанти на ринку.\r\nІндивідуальний підхід. Кожен клієнт унікальний. Ми уважно слухаємо ваші побажання та підбираємо варіанти, які підходять саме вам.\r\n\r\nУ FAKTOR ми віримо, що угода з нерухомістю має бути не стресом, а впевненим кроком уперед. Наша мета — щоб ви завершили співпрацю з нами із задоволенням і рекомендували нас своїм близьким.\r\nFAKTOR — ваш надійний партнер у світі нерухомості.",
                    'ua' => "FAKTOR — агентство нерухомості, яке будує свою роботу на головному: довірі, результаті та повазі до кожного клієнта. Ми допомагаємо купити, продати та орендувати нерухомість — швидко, безпечно та вигідно.\r\nНаша команда складається з досвідчених рієлторів, які досконало знають ринок і щиро зацікавлені в тому, щоб ви отримали найкраще рішення. Ми не нав'язуємо — ми радимо. Ми не поспішаємо — ми діємо точно.\r\nЧому клієнти обирають FAKTOR:\r\n\r\nДосвід і експертиза. Роки роботи на ринку нерухомості, сотні успішно закритих угод та глибоке розуміння того, як влаштований ринок зсередини.\r\nПовний супровід угоди. Від першої консультації до отримання ключів — ми поруч на кожному етапі та беремо на себе всі організаційні та юридичні питання.\r\nЧесні умови. Ніяких прихованих платежів і неприємних сюрпризів. Усі умови співпраці — відкрито та зрозуміло з першого дня.\r\nАктуальна база об'єктів. Ми постійно оновлюємо пропозиції та першими дізнаємося про найцікавіші варіанти на ринку.\r\nІндивідуальний підхід. Кожен клієнт унікальний. Ми уважно слухаємо ваші побажання та підбираємо варіанти, які підходять саме вам.\r\n\r\nУ FAKTOR ми віримо, що угода з нерухомістю має бути впевненим кроком уперед. Наша мета — щоб ви завершили співпрацю з нами із задоволенням і рекомендували нас своїм близьким.\r\nFAKTOR — ваш надійний партнер у світі нерухомості.",
                ],
                'country_id' => 1,
                'state_id' => 14,
                'region_id' => 27,
                ...
                'company_type' => 264,
                'logo_path' => 'companies/1/logo/joO4an1t2YoKni6MZN6CL3eK2RvxyJt6et1lE0Le.png',
                'is_active' => true,
            ]
        );
        ...
        // Офисы (только активные)
        $offices = [
            ['id' => 5, 'name' => 'FAKTOR Manhattan', 'name_translations' => ['en' => 'FAKTOR Manhattan', 'ru' => 'FAKTOR Manhattan', 'ua' => 'FAKTOR Manhattan'], 'country_id' => 1, 'state_id' => 14, 'region_id' => 27, 'city_id' => 1, 'district_id' => 2, 'zone_id' => 3, 'street_id' => 166, 'building_number' => '2/2', 'phone' => '(73) 355-34-84', 'full_address' => 'Филатова Академика, 2/2, Одесса', 'sort_order' => 0],
        ...
        // Сотрудники
        $employees = [
            ['id' => 1, 'user_id' => 1, 'office_id' => 5, 'position_id' => 332, 'status_id' => null, 'first_name' => 'Админ', 'last_name' => 'Головенко', 'middle_name' => null, 'email' => null, 'phone' => '+38 (095) 090-22-93'],
            ...
            ['id' => 11, 'user_id' => 11, 'office_id' => 5, 'position_id' => 330, 'status_id' => 333, 'first_name' => 'Юлия', 'last_name' => 'Зайцева', 'middle_name' => 'Викторовна', 'email' => 'user_185@factor.local', 'phone' => '+38 (067) 654-69-05'],
            ...
            ['id' => 13, 'user_id' => 13, 'office_id' => 6, 'position_id' => 330, 'status_id' => 333, 'first_name' => 'Инга', 'last_name' => 'Сергеева', 'middle_name' => 'Александровна', 'email' => 'user_202@factor.local', 'phone' => '+38 (067) 760-59-33'],
            ...
            ['id' => 22, 'user_id' => 22, 'office_id' => 7, 'position_id' => 330, 'status_id' => 333, 'first_name' => 'Марина', 'last_name' => 'Ботнарь', 'middle_name' => 'Константиновна', 'email' => 'user_263@factor.local', 'phone' => '+38 (093) 906-44-39'],
            ...
            ['id' => 27, 'user_id' => 27, 'office_id' => 9, 'position_id' => 330, 'status_id' => 333, 'first_name' => 'Сергей', 'last_name' => 'Величко', 'middle_name' => 'Сергеевич', 'email' => 'user_310@factor.local', 'phone' => '+38 (066) 215-02-45'],
            ...
            ['id' => 32, 'user_id' => 32, 'office_id' => 9, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Наталия', 'last_name' => 'Шарапова', 'middle_name' => 'Ивановна', 'email' => '7952055odessa@gmail.com', 'phone' => '+38 (068) 792-17-92'],
            ...
            ['id' => 36, 'user_id' => 36, 'office_id' => 9, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Владимир', 'last_name' => 'Минеско', 'middle_name' => 'Григорьевич', 'email' => 'vovamenesko.com@gmail.com', 'phone' => '+38 (096) 044-88-93'],
            ...
            ['id' => 38, 'user_id' => 38, 'office_id' => 9, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Мария', 'last_name' => 'Митрофанова', 'middle_name' => 'Николаевна', 'email' => 'm2998805@gmail.com', 'phone' => '+38 (050) 021-75-99'],
            ['id' => 39, 'user_id' => 39, 'office_id' => 6, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Ирина', 'last_name' => 'Михова', 'middle_name' => 'Юрьевна', 'email' => 'user_360@factor.local', 'phone' => '+38 (066) 995-33-27'],
            ['id' => 40, 'user_id' => 40, 'office_id' => 6, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Татьяна', 'last_name' => 'Малыхина', 'middle_name' => 'Ивановна', 'email' => 'user_361@factor.local', 'phone' => '+38 (096) 898-83-88'],
            ['id' => 41, 'user_id' => 41, 'office_id' => 9, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Ирина', 'last_name' => 'Давыденко', 'middle_name' => 'Анатольевна', 'email' => 'user_370@factor.local', 'phone' => '+38 (097) 897-13-31'],
            ['id' => 42, 'user_id' => 42, 'office_id' => 7, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Анна', 'last_name' => 'Супенко', 'middle_name' => 'Викторовна', 'email' => 'genation182@gmail.com', 'phone' => '+38 (063) 885-32-07'],
            ...
            ['id' => 44, 'user_id' => 44, 'office_id' => 7, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Инна', 'last_name' => 'Бернатович', 'middle_name' => 'Александровна', 'email' => 'bernarovichinna@gmail.com', 'phone' => '+38 (073) 032-36-34'],
            ['id' => 45, 'user_id' => 45, 'office_id' => 7, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Татьяна', 'last_name' => 'Ружицкая', 'middle_name' => 'Петровна', 'email' => 'tetianaruzhytska777@gmail.com', 'phone' => '+38 (097) 591-56-58'],
            ...
            ['id' => 73, 'user_id' => 73, 'office_id' => 8, 'position_id' => 330, 'status_id' => 333, 'first_name' => 'Лилия', 'last_name' => 'Грек', 'middle_name' => 'Федоровна', 'email' => 'user_489@factor.local', 'phone' => '+38 (096) 634-69-64'],
            ...
            ['id' => 81, 'user_id' => 81, 'office_id' => 5, 'position_id' => 327, 'status_id' => 333, 'first_name' => 'Александр', 'last_name' => 'Кучменко', 'middle_name' => 'Георгиевич', 'email' => 'user_498@factor.local', 'phone' => '+38 (099) 896-65-84'],
