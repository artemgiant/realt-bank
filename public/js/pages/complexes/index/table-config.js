/**
 * Конфигурация DataTables для таблицы комплексов
 * Объект доступен через window.ComplexTableConfig
 */
window.ComplexTableConfig = {

    // URL для AJAX запросов
    ajaxUrl: '/complexes/ajax-data',

    // Определение колонок
    getColumns: function() {
        var R = window.ComplexRenderers;
    ...
    language: {
        ...
        zeroRecords: '<div class="text-center py-4"><div class="text-muted"><p class="mb-2">Комплексы не найдены</p></div></div>',
