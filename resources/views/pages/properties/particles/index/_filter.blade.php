            ...
            <div class="header-btn">
                ...
                <div class="full-filter-btn-wrapper">
                    ...
                    <div class="full-filter-counter" style="{{ $activeFiltersCount > 0 ? '' : 'display: none;' }}">
                        ...
                        <button type="button" id="delete-params-on-filter" onclick="window.location.href='{{ route('properties.index') }}'">
                ...
                <div class="full-filter-row">
                    ...
                    <div class="item search-on-id">
                        ...
                        <div class="item-inputSearch-wrapper">
                            ...
                            <button class="item-inputSearchBtn" type="submit">
                    ...
                    <div class="item filter-btn-outline">
                        <a href="{{ route('properties.index') }}" class="btn btn-outline-primary">Сбросить</a>
                    </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Автосабмит при изменении основных select'ов в хедере
            $('#deal_type_id, #currency_id').on('change', function() {
                // Опционально: автосабмит формы
                // $('#filter-form').submit();
            });
        });
    </script>
