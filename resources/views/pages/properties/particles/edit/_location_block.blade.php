...
<div class="item selects w16">
    ...
    <div class="state-search-wrapper">
        <input type="text"
               ...
               autocomplete="off"
               value="{{ old('state_name', $property->state?->name) }}"
               required>
        ...
        <input type="hidden" name="state_id" id="state_id" value="{{ old('state_id', $property->state_id) }}" required>
        <input type="hidden" name="state_name" id="state_name" value="{{ old('state_name', $property->state?->name) }}">
        <input type="hidden" name="country_id" id="country_id" value="{{ old('country_id', $property->country_id) }}">
        <input type="hidden" name="country_name" id="country_name" value="{{ old('country_name', $property->country?->name) }}">
    </div>
</div>
...
<div class="item w33">
    ...
    <div class="location-search-wrapper">
        <input type="text"
               ...
               autocomplete="off"
               value="{{ old('street_name', $property->street?->name) }}"
               required>
        ...
        <input type="hidden" name="street_id" value="{{ old('street_id', $property->street_id) }}" required>
        <input type="hidden" name="street_name" value="{{ old('street_name', $property->street?->name) }}">
        <input type="hidden" name="zone_id" value="{{ old('zone_id', $property->zone_id) }}">
        <input type="hidden" name="zone_name" value="{{ old('zone_name', $property->zone?->name) }}">
        <input type="hidden" name="district_id" value="{{ old('district_id', $property->district_id) }}">
...
<div class="item w16">
    ...
    <div class="item-inputText-wrapper shtrih">
        <input class="item-inputText" id="number-house" name="building_number" type="text" autocomplete="off" value="{{ old('building_number', $property->building_number) }}">
