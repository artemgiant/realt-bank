...
@php
    ...
    $translationUa = $property->getTranslation('ua');
    $translationRu = $property->getTranslation('ru');
    $translationEn = $property->getTranslation('en');
@endphp
    ...
    <div class="create-header">
        <div class="create-header-left">
            ...
            <h2 class="create-header-title">
                Объект
                <span id="property-id">#{{ $property->id }}</span>
            </h2>
        </div>
        <div class="create-header-right">
            <div class="create-header-add">
                Добавлено:
                <span id="created-at">{{ $property->created_at->format('d.m.Y') }}</span>
            </div>
            <div class="create-header-update">
                Обновлено:
                <span id="updated-at">{{ $property->updated_at->format('d.m.Y') }}</span>
            </div>
        </div>
    </div>
@endsection
        ...
        <form id="property-form" action="{{ route('properties.update', $property) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="create-filter">
                <div class="create-filter-data">
                    ...
                    @include('pages.properties.particles.edit._contact_and_agent')
                    ...
                    <div class="create-filter-row">
                        ...
                        <div class="item selects blue-select2 ">
                            ...
                            <select id="deal_type_id" name="deal_type_id" class="js-example-responsive2" required>
                                ...
                                @foreach($dealTypes as $dealType)
                                    <option value="{{ $dealType->id }}" {{ old('deal_type_id', $property->deal_type_id) == $dealType->id ? 'selected' : '' }}>
                                        {{ $dealType->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="deal_kind_id" name="deal_kind_id" class="js-example-responsive3 my-select2" required>
                                ...
                                @foreach($dealKinds as $dealKind)
                                    <option value="{{ $dealKind->id }}" {{ old('deal_kind_id', $property->deal_kind_id) == $dealKind->id ? 'selected' : '' }}>
                                        {{ $dealKind->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="complex_id" name="complex_id" class="form-control" autocomplete="off">
                                <option value=""></option>
                                @if($property->complex)
                                    <option value="{{ $property->complex->id }}" selected>{{ $property->complex->name }}</option>
                                @endif
                            </select>
                        </div>
                        ...
                        <div class="item selects  w33">
                            ...
                            <select id="block_id" name="block_id" class="form-control" autocomplete="off" {{ $property->complex_id ? '' : 'disabled' }}>
                                <option value=""></option>
                                @if($property->block)
                                    <option value="{{ $property->block->id }}" selected>{{ $property->block->name }}</option>
                                @endif
                            </select>
                        </div>
                        ...
                        @include('pages.properties.particles.edit._location_block')
                        ...
                        <div class="item selects ">
                            ...
                            <select id="room_count_id" name="room_count_id" class="js-example-responsive3 my-select2">
                                ...
                                @foreach($roomCounts as $roomCount)
                                    <option value="{{ $roomCount->id }}" {{ old('room_count_id', $property->room_count_id) == $roomCount->id ? 'selected' : '' }}>
                                        {{ $roomCount->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="bathroom_count_id" name="bathroom_count_id" class="js-example-responsive3 my-select2">
                                ...
                                @foreach($bathroomCounts as $bathroomCount)
                                    <option value="{{ $bathroomCount->id }}" {{ old('bathroom_count_id', $property->bathroom_count_id) == $bathroomCount->id ? 'selected' : '' }}>
                                        {{ $bathroomCount->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="condition_id" name="condition_id" class="js-example-responsive3 my-select2">
                                ...
                                @foreach($conditions as $condition)
                                    <option value="{{ $condition->id }}" {{ old('condition_id', $property->condition_id) == $condition->id ? 'selected' : '' }}>
                                        {{ $condition->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item ">
                            ...
                            <div class="item-inputText-wrapper shtrih2">
                                <input class="item-inputText" id="area_total" name="area_total" type="text"
                                       value="{{ old('area_total', $property->area_total) }}" autocomplete="off" placeholder="000">
                                <input class="item-inputText" id="area_living" name="area_living" type="text"
                                       value="{{ old('area_living', $property->area_living) }}" autocomplete="off" placeholder="000">
                                <input class="item-inputText" id="area_kitchen" name="area_kitchen" type="text"
                                       value="{{ old('area_kitchen', $property->area_kitchen) }}" autocomplete="off" placeholder="000">
                            </div>
                        </div>
                        ...
                        <div class="item ">
                            ...
                            <div class="item-inputText-wrapper">
                                <input class="item-inputText" id="area_land" name="area_land" type="text"
                                       value="{{ old('area_land', $property->area_land) }}" autocomplete="off" placeholder="Сотки">
                            </div>
                        </div>
                        ...
                        <div class="item ">
                            ...
                            <div class="item-inputText-wrapper shtrih">
                                <input class="item-inputText" id="floor" name="floor" type="text"
                                       value="{{ old('floor', $property->floor) }}" autocomplete="off">
                                <input class="item-inputText" id="floors_total" name="floors_total" type="text"
                                       value="{{ old('floors_total', $property->floors_total) }}" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="ceiling_height_id" name="ceiling_height_id" class="js-example-responsive3 my-select2">
                                ...
                                @foreach($ceilingHeights as $ceilingHeight)
                                    <option value="{{ $ceilingHeight->id }}" {{ old('ceiling_height_id', $property->ceiling_height_id) == $ceilingHeight->id ? 'selected' : '' }}>
                                        {{ $ceilingHeight->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="wall_type_id" name="wall_type_id" class="js-example-responsive3 my-select2" required>
                                ...
                                @foreach($wallTypes as $wallType)
                                    <option value="{{ $wallType->id }}" {{ old('wall_type_id', $property->wall_type_id) == $wallType->id ? 'selected' : '' }}>
                                        {{ $wallType->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="heating_type_id" name="heating_type_id" class="js-example-responsive3 my-select2">
                                ...
                                @foreach($heatingTypes as $heatingType)
                                    <option value="{{ $heatingType->id }}" {{ old('heating_type_id', $property->heating_type_id) == $heatingType->id ? 'selected' : '' }}>
                                        {{ $heatingType->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="year_built" name="year_built" class="js-example-responsive3 my-select2">
                                ...
                                @foreach($yearsBuilt as $yearBuilt)
                                    <option value="{{ $yearBuilt->id }}" {{ old('year_built', $property->year_built) == $yearBuilt->id ? 'selected' : '' }}>
                                        {{ $yearBuilt->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item ">
                            ...
                            <div class="item-inputText-wrapper">
                                <input class="item-inputText" id="price" name="price" type="text"
                                       value="{{ old('price', $property->price) }}" autocomplete="off" placeholder="" required>
                            </div>
                            @error('price')
                            <span class="text-danger small">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="item ">
                            ...
                            <div class="item-inputText-wrapper">
                                <input class="item-inputText" id="commission" name="commission" type="text"
                                       value="{{ old('commission', $property->commission) }}" autocomplete="off" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="item selects ">
                            ...
                            <select id="source_id" name="source_id" class="js-example-responsive2 my-select2" required>
                                ...
                                @foreach($sources as $source)
                                    <option value="{{ $source->id }}" {{ old('source_id', $property->source_id) == $source->id ? 'selected' : '' }}>
                                        {{ $source->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="item ">
                            ...
                            <div class="item-inputText-wrapper">
                                <input class="item-inputText" id="youtube_url" name="youtube_url" type="url"
                                       value="{{ old('youtube_url', $property->youtube_url) }}" autocomplete="off" placeholder="https://youtube.com/...">
                            </div>
                        </div>
                        ...
                        <div class="item ">
                            ...
                            <div class="item-inputText-wrapper">
                                <input class="item-inputText" id="tiktok_url" name="tiktok_url" type="url"
                                       value="{{ old('tiktok_url', $property->tiktok_url) }}" autocomplete="off" placeholder="https://tiktok.com/...">
                            </div>
                        </div>
                        ...
                        <div class="item selects w33">
                            ...
                            <select id="contact_type_id" name="contact_type_id" class="js-example-responsive3 my-select2" required>
                                ...
                                @foreach($contactTypes as $contactType)
                                    <option value="{{ $contactType->id }}" {{ old('contact_type_id', $property->contact_type_id) == $contactType->id ? 'selected' : '' }}>
                                        {{ $contactType->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        {{-- Особенности --}}
                        @include('pages.properties.particles.edit._features_block')
                ...
                <div class="create-filter-documents">
                            ...
                            <div class="note_advertising-wrapper">
                                ...
                                <div class="item-inputText-wrapper">
                                    <textarea class="item-textareaText" id="agent_notes" name="agent_notes"
                                              autocomplete="off" placeholder="Введите текст">{{ old('agent_notes', $property->agent_notes) }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="right">
                                            ...
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <textarea class="item-textareaText" rows="10" data-input-lang="ua"
                                                              ...
                                                              placeholder="Введите текст">{{ old('description_ua', $translationUa?->description) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <textarea class="item-textareaText" rows="10" data-input-lang="ru"
                                                              ...
                                                              placeholder="Введите текст">{{ old('description_ru', $translationRu?->description) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <textarea class="item-textareaText" rows="10" data-input-lang="en"
                                                              ...
                                                              placeholder="Enter text">{{ old('description_en', $translationEn?->description) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    @if($property->documents->count() > 0)
                        <div class="loading-documents document mb-3">
                            <span class="item-label">Загруженные документы</span>
                            <div class="filter-tags">
                                @foreach($property->documents as $doc)
                                    <div class="filter-tag">
                                        <a href="{{ route('documents.download', $doc->hash ?? $doc->id) }}" target="_blank">
