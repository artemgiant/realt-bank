...
{{--#TODO TODO: Додати вибір Контакту і Агента--}}
...
{{--                        --}}{{-- Секція / Корпус --}}
{{--                        todo: Додати вибір секції / корпусу--}}
...
{{--                        </div>--}}
                        ...
                        {{-- Локація --}}
{{--                        TODO: Відновити локацію після виправлення проблем з продуктивністю--}}
{{--                        <div class="item w50">--}}
{{--                            <label>Локація</label>--}}
...
{{--                        </div>--}}
                        ...
                        {{-- Особливості --}}
{{--                        #todo додати пошук по особливостях--}}
{{--                        <div class="item">--}}
