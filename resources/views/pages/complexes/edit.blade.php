...
@section('content')
    ...
    <form action="{{ route('complexes.update', $complex) }}" method="POST" enctype="multipart/form-data" id="complex-form">
        @csrf
        @method('PUT')
        ...
        <div class="create-filter">
            ...
            <div class="create-filter-wrapper">
                                        ...
                                        <div class="text_advertising-wrapper">
                                            ...
                                            <div class="item-inputText-wrapper">
                                                <input class="item-inputText" type="text"
                                                       ...
                                                       name="name_ua"
                                                       value="{{ old('name_ua', $complex->name_translations['ua'] ?? '') }}"
                                                       placeholder="Назва">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="text_advertising-wrapper">
                                            ...
                                            <div class="item-inputText-wrapper">
                                                <input class="item-inputText" type="text"
                                                       ...
                                                       name="name_ru"
                                                       value="{{ old('name_ru', $complex->name_translations['ru'] ?? $complex->name) }}"
                                        ...
                                        <div class="text_advertising-wrapper">
                                            ...
                                            <div class="item-inputText-wrapper">
                                                <input class="item-inputText" type="text"
                                                       ...
                                                       name="name_en"
                                                       value="{{ old('name_en', $complex->name_translations['en'] ?? '') }}"
                                        ...
                                        <div class="text_advertising-wrapper">
                                            ...
                                            <div class="item-inputText-wrapper">
												<textarea class="item-textareaText"
                                                          ...
                                                          autocomplete="off"
                                                          name="description_ua"
                                                          placeholder="Введіть текст">{{ old('description_ua', $complex->description_translations['ua'] ?? '') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="text_advertising-wrapper">
                                            ...
                                            <div class="item-inputText-wrapper">
												<textarea class="item-textareaText"
                                                          ...
                                                          autocomplete="off"
                                                          name="description_ru"
                                                          placeholder="Введите текст">{{ old('description_ru', $complex->description_translations['ru'] ?? $complex->description) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="text_advertising-wrapper">
                                            ...
                                            <div class="item-inputText-wrapper">
												<textarea class="item-textareaText"
                                                          ...
                                                          autocomplete="off"
                                                          name="description_en"
                                                          placeholder="Enter text">{{ old('description_en', $complex->description_translations['en'] ?? '') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="create-filter-right">
                    ...
                    <div id="contacts-list-container">
                        @foreach($complex->contacts as $contact)
                            <div class="contact-card mb-3" data-contact-id="{{ $contact->id }}">
                                <input type="hidden" name="contact_ids[]" class="contact-id-input" value="{{ $contact->id }}">
                                <ul class="block-info">
                    ...
                    <div class="item" @if($complex->contacts->count() > 0) style="display: none;" @endif>
                    ...
                    {{-- Кнопка добавления еще одного контакта --}}
                    <div id="add-more-contact-btn" class="{{ $complex->contacts->count() > 0 ? '' : 'd-none' }} mb-3">
                    ...
                    <div class="loading-documents loading-logo">
                        ...
                        <div class="filter-tags" data-render-document>
                            @if($complex->logo_path)
                                <div class="existing-logo-preview mb-2">
                                    <img src="{{ Storage::url($complex->logo_path) }}" alt="Логотип" style="max-width: 100px; max-height: 100px;">
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="item">
                        ...
                        <select id="developer_id" name="developer_id" class="js-example-responsive3 my-select2" autocomplete="off">
                            ...
                            @if($complex->developer)
                                <option value="{{ $complex->developer->id }}" selected>{{ $complex->developer->name }}</option>
                            @endif
                        </select>
                    </div>
                    <div class="item">
                    ...
                    <div class="item w50">
                        ...
                        <div class="item-inputText-wrapper">
                            <input class="item-inputText" type="text" id="agent_notes" name="agent_notes"
                                   value="{{ old('agent_notes', $complex->agent_notes) }}"
                    ...
                    <div class="item">
                        ...
                        <div class="item-inputText-wrapper">
                            <input class="item-inputText" type="url" id="company_website" name="company_website"
                                   value="{{ old('company_website', $complex->company_website) }}"
                                   autocomplete="off" placeholder="https://linkname.com">
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="item-inputText-wrapper">
                            <input class="item-inputText" type="url" id="materials_url" name="materials_url"
                                   value="{{ old('materials_url', $complex->materials_url) }}"
                                   autocomplete="off" placeholder="https://linkname.com">
                        </div>
                    </div>
                    <div class="item w50">
                        ...
                        <div class="item-inputText-wrapper">
                            <input class="item-inputText" type="text" id="special_conditions" name="special_conditions"
                                   value="{{ old('special_conditions', $complex->special_conditions) }}"
                                   autocomplete="off" placeholder="Введите текст">
                        </div>
                    </div>
                </div>
            ...
            <div class="create-filter-documents">
                <div class="loading-plan">
                    <label for="plans">
                        <input type="file" id="plans" name="plans[]" multiple accept="image/png, image/jpeg, image/webp">
                        <span>
							<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							    <path d="M8.50627 13.2938C7.81303 13.9437 6.89417 14.2986 5.94403 14.2833C4.99388 14.2679 4.08694 13.8837 3.41499 13.2117C2.74305 12.5398 2.35879 11.6329 2.34348 10.6827C2.32817 9.73256 2.683 8.81371 3.33294 8.12046L9.17294 2.28713C9.52011 1.94269 9.96138 1.70858 10.4412 1.61425C10.9211 1.51991 11.4181 1.56956 11.8699 1.75695C12.3216 1.94433 12.7078 2.2611 12.98 2.6674C13.2522 3.0737 13.3982 3.55141 13.3996 4.04046C13.3992 4.36567 13.3342 4.68757 13.2083 4.98743C13.0824 5.28729 12.8982 5.55912 12.6663 5.78713L7.11294 11.3338C6.93932 11.4722 6.72095 11.5421 6.49924 11.5302C6.27753 11.5183 6.06789 11.4254 5.91008 11.2692C5.75226 11.1131 5.65723 10.9044 5.64302 10.6828C5.6288 10.4613 5.69638 10.2422 5.83294 10.0671L11.3929 4.50713L10.4463 3.56713L4.88627 9.12713C4.48502 9.55082 4.26495 10.1144 4.27289 10.6978C4.28082 11.2813 4.51614 11.8387 4.92876 12.2513C5.34138 12.6639 5.89874 12.8992 6.48222 12.9072C7.0657 12.9151 7.62925 12.695 8.05294 12.2938L13.6196 6.73379C14.3357 6.01859 14.7383 5.04822 14.739 4.03615C14.7396 3.02408 14.3381 2.05321 13.6229 1.33713C12.9077 0.621043 11.9374 0.218399 10.9253 0.217774C9.91323 0.217149 8.94236 0.618593 8.22627 1.33379L2.38627 7.18046C1.48313 8.1234 0.985245 9.38258 0.999314 10.6882C1.01338 11.9938 1.53828 13.2419 2.46154 14.1652C3.38479 15.0885 4.63295 15.6133 5.93855 15.6274C7.24416 15.6415 8.50334 15.1436 9.44627 14.2405L14.7263 8.95379L13.7863 8.00046L8.50627 13.2938Z" fill="#3585F5"/>
						    </svg>
							<span class="text">Загрузить план</span>
						</span>
                    </label>
                    <div class="filter-tags" data-render-document>
                        @if($complex->plans)
                            @foreach($complex->plans as $index => $planPath)
                                <div class="existing-media-item" data-index="{{ $index }}">
                                    <img src="{{ Storage::url($planPath) }}" alt="План {{ $index + 1 }}" style="max-width: 80px; max-height: 80px;">
                                    <label class="delete-checkbox">
                                        <input type="checkbox" name="delete_plans[]" value="{{ $index }}">
                                        <span>Удалить</span>
                                    </label>
                                </div>
                            @endforeach
            ...
            <div class="create-filter-photo">
                <div class="photo-info">
                    <div class="photo-info-wrapper">
                        <span class="photo-info-title">Фото комплекса (первое фото будет обложкой объявления)</span>
                    ...
                    @if($complex->photos)
                        <div class="existing-photos-container mt-3">
                            <div class="row">
                                @foreach($complex->photos as $index => $photoPath)
                                    <div class="col-auto mb-2 existing-media-item" data-index="{{ $index }}">
                                        <div class="position-relative">
                                            <img src="{{ Storage::url($photoPath) }}" alt="Фото {{ $index + 1 }}" style="max-width: 120px; max-height: 120px; object-fit: cover;">
                                            <label class="delete-checkbox position-absolute" style="top: 5px; right: 5px;">
                                                <input type="checkbox" name="delete_photos[]" value="{{ $index }}">
                ...
                <div class="create-filter-row">
                    ...
                    <div class="item w10">
                        ...
                        <div class="multiple-menu" id="conditions-menu">
                            ...
                            <div class="multiple-menu-wrapper">
                                <ul class="multiple-menu-list">
                                    @php
                                        $selectedConditions = old('conditions', $complex->conditions ?? []);
                                        if (is_string($selectedConditions)) {
                                            $selectedConditions = json_decode($selectedConditions, true) ?? [];
                                        }
                                    @endphp
                    ...
                    <div class="item w10">
                        ...
                        <div class="item-inputText-wrapper shtrih">
                            <input class="item-inputText" id="area_from" name="area_from" type="number" step="0.01"
                                   value="{{ old('area_from', $complex->area_from) }}" placeholder="От" autocomplete="off" min="0">
                            <input class="item-inputText" id="area_to" name="area_to" type="number" step="0.01"
                                   value="{{ old('area_to', $complex->area_to) }}" placeholder="До" autocomplete="off" min="0">
                        </div>
                    </div>
                    <div class="item w15">
						<span>
                    ...
                    <div class="item w10">
                        ...
                        <select id="currency" name="currency" class="js-example-responsive2" autocomplete="off">
                            <option value="USD" {{ old('currency', $complex->currency ?? 'USD') == 'USD' ? 'selected' : '' }}>USD</option>
                            <option value="UAH" {{ old('currency', $complex->currency) == 'UAH' ? 'selected' : '' }}>UAH</option>
                            <option value="EUR" {{ old('currency', $complex->currency) == 'EUR' ? 'selected' : '' }}>EUR</option>
                        </select>
                    </div>

                    {{-- Особенности --}}
                    @include('pages.complexes.particles.edit._features_block')
                ...
                <div class="create-filter-locations">
                    ...
                    <ul class="create-filter-locations-list" id="blocks-list">
                        @forelse($complex->blocks as $index => $block)
                            <li class="create-filter-locations-item block-item" data-block-index="{{ $index }}">
                                <input type="hidden" name="blocks[{{ $index }}][id]" value="{{ $block->id }}">
                                <div class="item w15">
                                    <label class="green" for="blocks-{{ $index }}-name">Названия</label>
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" type="text" id="blocks-{{ $index }}-name" name="blocks[{{ $index }}][name]"
                                               value="{{ old("blocks.{$index}.name", $block->name) }}" autocomplete="off" placeholder="">
                                    </div>
                                ...
                                <div class="item w15">
                                    <label class="item-label" for="blocks-{{ $index }}-street_id">Улица</label>
                                    <select id="blocks-{{ $index }}-street_id" name="blocks[{{ $index }}][street_id]" class="js-example-responsive3 my-select2 block-street-select" autocomplete="off">
                                        <option value="">Выберите улицу</option>
                                        @if($block->street)
                                            <option value="{{ $block->street->id }}" selected>{{ $block->street->name }}</option>
                                        @endif
                                    </select>
                                </div>
                                <div class="item w7-5">
                                    <label for="blocks-{{ $index }}-building_number">№ Дом</label>
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" type="text" id="blocks-{{ $index }}-building_number" name="blocks[{{ $index }}][building_number]"
                                               value="{{ old("blocks.{$index}.building_number", $block->building_number) }}" autocomplete="off" placeholder="Номер">
                                    </div>
                                </div>
                                <div class="item w7-5">
                                    <label for="blocks-{{ $index }}-floors_total">Этажность</label>
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" type="number" id="blocks-{{ $index }}-floors_total" name="blocks[{{ $index }}][floors_total]"
                                               value="{{ old("blocks.{$index}.floors_total", $block->floors_total) }}" autocomplete="off" placeholder="Кол-во" min="1" max="200">
                                    </div>
                                </div>
                                <div class="item w10">
                                    <label class="item-label" for="blocks-{{ $index }}-year_built">Год сдачи</label>
                                    <select id="blocks-{{ $index }}-year_built" name="blocks[{{ $index }}][year_built]" class="js-example-responsive3 my-select2" autocomplete="off">
                                        <option value="">Выберите</option>
                                        @foreach($yearsBuilt as $year)
                                            <option value="{{ $year->value }}" {{ old("blocks.{$index}.year_built", $block->year_built) == $year->value ? 'selected' : '' }}>
                                                {{ $year->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="item w15">
                                    <label class="item-label" for="blocks-{{ $index }}-heating_type_id">Отопление</label>
                                    <select id="blocks-{{ $index }}-heating_type_id" name="blocks[{{ $index }}][heating_type_id]" class="js-example-responsive3 my-select2" autocomplete="off">
                                        <option value="">Выберите</option>
                                        @foreach($heatingTypes as $heating)
                                            <option value="{{ $heating->id }}" {{ old("blocks.{$index}.heating_type_id", $block->heating_type_id) == $heating->id ? 'selected' : '' }}>
                                                {{ $heating->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="item w15">
                                    <label class="item-label" for="blocks-{{ $index }}-wall_type_id">Тип стен</label>
                                    <select id="blocks-{{ $index }}-wall_type_id" name="blocks[{{ $index }}][wall_type_id]" class="js-example-responsive3 my-select2" autocomplete="off">
                                        <option value="">Выберите</option>
                                        @foreach($wallTypes as $wall)
                                            <option value="{{ $wall->id }}" {{ old("blocks.{$index}.wall_type_id", $block->wall_type_id) == $wall->id ? 'selected' : '' }}>
                                                {{ $wall->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="item w10">
                                    <div class="loading-plan" data-plan-id="plan-{{ $index }}">
                                        <label for="blocks-{{ $index }}-plan">
                                            <input type="file" id="blocks-{{ $index }}-plan" name="blocks[{{ $index }}][plan]" accept="image/png, image/jpeg, image/webp">
                                            <span>
											    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
												    <path d="M8.50627 13.2938C7.81303 13.9437 6.89417 14.2986 5.94403 14.2833C4.99388 14.2679 4.08694 13.8837 3.41499 13.2117C2.74305 12.5398 2.35879 11.6329 2.34348 10.6827C2.32817 9.73256 2.683 8.81371 3.33294 8.12046L9.17294 2.28713C9.52011 1.94269 9.96138 1.70858 10.4412 1.61425C10.9211 1.51991 11.4181 1.56956 11.8699 1.75695C12.3216 1.94433 12.7078 2.2611 12.98 2.6674C13.2522 3.0737 13.3982 3.55141 13.3996 4.04046C13.3992 4.36567 13.3342 4.68757 13.2083 4.98743C13.0824 5.28729 12.8982 5.55912 12.6663 5.78713L7.11294 11.3338C6.93932 11.4722 6.72095 11.5421 6.49924 11.5302C6.27753 11.5183 6.06789 11.4254 5.91008 11.2692C5.75226 11.1131 5.65723 10.9044 5.64302 10.6828C5.6288 10.4613 5.69638 10.2422 5.83294 10.0671L11.3929 4.50713L10.4463 3.56713L4.88627 9.12713C4.48502 9.55082 4.26495 10.1144 4.27289 10.6978C4.28082 11.2813 4.51614 11.8387 4.92876 12.2513C5.34138 12.6639 5.89874 12.8992 6.48222 12.9072C7.0657 12.9151 7.62925 12.695 8.05294 12.2938L13.6196 6.73379C14.3357 6.01859 14.7383 5.04822 14.739 4.03615C14.7396 3.02408 14.3381 2.05321 13.6229 1.33713C12.9077 0.621043 11.9374 0.218399 10.9253 0.217774C9.91323 0.217149 8.94236 0.618593 8.22627 1.33379L2.38627 7.18046C1.48313 8.1234 0.985245 9.38258 0.999314 10.6882C1.01338 11.9938 1.53828 13.2419 2.46154 14.1652C3.38479 15.0885 4.63295 15.6133 5.93855 15.6274C7.24416 15.6415 8.50334 15.1436 9.44627 14.2405L14.7263 8.95379L13.7863 8.00046L8.50627 13.2938Z" fill="#3585F5"/>
											    </svg>
                                ...
                                <div class="item w100" data-plan-id="plan-file-{{ $index }}">
                                    <div class="filter-tags" data-render-document>
                                        @if($block->plan_path)
                                            <div class="existing-media-item">
                                                <img src="{{ Storage::url($block->plan_path) }}" alt="План секции" style="max-width: 80px; max-height: 80px;">
                                            </div>
                                        @endif
                                    </div>
                                    <div class="error-container" data-error></div>
                        ...
                        @empty
                            <li class="create-filter-locations-item block-item" data-block-index="0">
                                <div class="item w15">
                                    <label class="green" for="blocks-0-name">Названия</label>
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" type="text" id="blocks-0-name" name="blocks[0][name]" value="" autocomplete="off" placeholder="">
                                    </div>
                                    <div class="add_new-tel">
                                ...
                                <div class="item w7-5">
                                    ...
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" type="text" id="blocks-0-building_number" name="blocks[0][building_number]" value="" autocomplete="off" placeholder="Номер">
                                    </div>
                                </div>
                                <div class="item w7-5">
                                    <label for="blocks-0-floors_total">Этажность</label>
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" type="number" id="blocks-0-floors_total" name="blocks[0][floors_total]" value="" autocomplete="off" placeholder="Кол-во" min="1" max="200">
                                    </div>
                                </div>
                                <div class="item w10">
                                ...
                                <div class="item w10">
                                    <div class="loading-plan" data-plan-id="plan-0">
                                        <label for="blocks-0-plan">
                                            <input type="file" id="blocks-0-plan" name="blocks[0][plan]" accept="image/png, image/jpeg, image/webp">
                                            <span>
											    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
												    <path d="M8.50627 13.2938C7.81303 13.9437 6.89417 14.2986 5.94403 14.2833C4.99388 14.2679 4.08694 13.8837 3.41499 13.2117C2.74305 12.5398 2.35879 11.6329 2.34348 10.6827C2.32817 9.73256 2.683 8.81371 3.33294 8.12046L9.17294 2.28713C9.52011 1.94269 9.96138 1.70858 10.4412 1.61425C10.9211 1.51991 11.4181 1.56956 11.8699 1.75695C12.3216 1.94433 12.7078 2.2611 12.98 2.6674C13.2522 3.0737 13.3982 3.55141 13.3996 4.04046C13.3992 4.36567 13.3342 4.68757 13.2083 4.98743C13.0824 5.28729 12.8982 5.55912 12.6663 5.78713L7.11294 11.3338C6.93932 11.4722 6.72095 11.5421 6.49924 11.5302C6.27753 11.5183 6.06789 11.4254 5.91008 11.2692C5.75226 11.1131 5.65723 10.9044 5.64302 10.6828C5.6288 10.4613 5.69638 10.2422 5.83294 10.0671L11.3929 4.50713L10.4463 3.56713L4.88627 9.12713C4.48502 9.55082 4.26495 10.1144 4.27289 10.6978C4.28082 11.2813 4.51614 11.8387 4.92876 12.2513C5.34138 12.6639 5.89874 12.8992 6.48222 12.9072C7.0657 12.9151 7.62925 12.695 8.05294 12.2938L13.6196 6.73379C14.3357 6.01859 14.7383 5.04822 14.739 4.03615C14.7396 3.02408 14.3381 2.05321 13.6229 1.33713C12.9077 0.621043 11.9374 0.218399 10.9253 0.217774C9.91323 0.217149 8.94236 0.618593 8.22627 1.33379L2.38627 7.18046C1.48313 8.1234 0.985245 9.38258 0.999314 10.6882C1.01338 11.9938 1.53828 13.2419 2.46154 14.1652C3.38479 15.0885 4.63295 15.6133 5.93855 15.6274C7.24416 15.6415 8.50334 15.1436 9.44627 14.2405L14.7263 8.95379L13.7863 8.00046L8.50627 13.2938Z" fill="#3585F5"/>
											    </svg>
                ...
                <template id="block-template">
                    <li class="create-filter-locations-item block-item" data-block-index="__INDEX__">
                        ...
                        <div class="item w7-5">
                            ...
                            <div class="item-inputText-wrapper">
                                <input class="item-inputText" type="text" id="blocks-__INDEX__-building_number" name="blocks[__INDEX__][building_number]" autocomplete="off" placeholder="Номер">
                            </div>
                        </div>
                        <div class="item w7-5">
                            <label for="blocks-__INDEX__-floors_total">Этажность</label>
                            <div class="item-inputText-wrapper">
                                <input class="item-inputText" type="number" id="blocks-__INDEX__-floors_total" name="blocks[__INDEX__][floors_total]" autocomplete="off" placeholder="Кол-во" min="1" max="200">
                            </div>
                        </div>
                        <div class="item w10">
                        ...
                        <div class="item w10">
                            <div class="loading-plan" data-plan-id="plan-__INDEX__">
                                <label for="blocks-__INDEX__-plan">
                                    <input type="file" id="blocks-__INDEX__-plan" name="blocks[__INDEX__][plan]" accept="image/png, image/jpeg, image/webp">
                                    <span>
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8.50627 13.2938C7.81303 13.9437 6.89417 14.2986 5.94403 14.2833C4.99388 14.2679 4.08694 13.8837 3.41499 13.2117C2.74305 12.5398 2.35879 11.6329 2.34348 10.6827C2.32817 9.73256 2.683 8.81371 3.33294 8.12046L9.17294 2.28713C9.52011 1.94269 9.96138 1.70858 10.4412 1.61425C10.9211 1.51991 11.4181 1.56956 11.8699 1.75695C12.3216 1.94433 12.7078 2.2611 12.98 2.6674C13.2522 3.0737 13.3982 3.55141 13.3996 4.04046C13.3992 4.36567 13.3342 4.68757 13.2083 4.98743C13.0824 5.28729 12.8982 5.55912 12.6663 5.78713L7.11294 11.3338C6.93932 11.4722 6.72095 11.5421 6.49924 11.5302C6.27753 11.5183 6.06789 11.4254 5.91008 11.2692C5.75226 11.1131 5.65723 10.9044 5.64302 10.6828C5.6288 10.4613 5.69638 10.2422 5.83294 10.0671L11.3929 4.50713L10.4463 3.56713L4.88627 9.12713C4.48502 9.55082 4.26495 10.1144 4.27289 10.6978C4.28082 11.2813 4.51614 11.8387 4.92876 12.2513C5.34138 12.6639 5.89874 12.8992 6.48222 12.9072C7.0657 12.9151 7.62925 12.695 8.05294 12.2938L13.6196 6.73379C14.3357 6.01859 14.7383 5.04822 14.739 4.03615C14.7396 3.02408 14.3381 2.05321 13.6229 1.33713C12.9077 0.621043 11.9374 0.218399 10.9253 0.217774C9.91323 0.217149 8.94236 0.618593 8.22627 1.33379L2.38627 7.18046C1.48313 8.1234 0.985245 9.38258 0.999314 10.6882C1.01338 11.9938 1.53828 13.2419 2.46154 14.1652C3.38479 15.0885 4.63295 15.6133 5.93855 15.6274C7.24416 15.6415 8.50334 15.1436 9.44627 14.2405L14.7263 8.95379L13.7863 8.00046L8.50627 13.2938Z" fill="#3585F5"/>
                                        </svg>
                ...
                <div class="create-btnGroup">
                    <div class="create-btnGroup-wrapper">
                        <div class="create-btnGroup-left">
                            <a href="{{ route('complexes.index') }}" class="btn btn-outline-primary">Отменить</a>
                        </div>
