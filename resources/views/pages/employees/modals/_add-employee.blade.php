                    ...
                    <div class="modal-body-l">
                        ...
                        <div class="modal-row">
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="first_name" name="first_name" type="text" autocomplete="off" placeholder="Имя" required>
                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="last_name" name="last_name" type="text" autocomplete="off" placeholder="Фамилия" required>
                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="middle_name" name="middle_name" type="text" autocomplete="off" placeholder="Отчество">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-row">
                            <div class="item phone">
                                <div class="item" data-phone-item>
                                    ...
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText tel-contact" id="phone" name="phone" type="tel" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="email" name="email" type="email" autocomplete="off">
                                </div>
                                <div class="invalid-feedback" data-field="email"></div>
                            </div>
                            <div class="item selects">
                                <label class="item-label" for="tag_ids">Теги</label>
                                <select id="tag_ids" name="tag_ids[]" class="js-example-responsive2 my-select2" multiple autocomplete="off">
                                    @foreach($tags as $tag)
                        ...
                        <div class="modal-row">
                            <div class="item selects">
                                ...
                                <select id="position_id" name="position_id" class="js-example-responsive2 my-select2" autocomplete="off">
                                    <option></option>
                            ...
                            <div class="item selects">
                                ...
                                <select id="office_id" name="office_id" class="js-example-responsive2 my-select2" autocomplete="off">
                                    <option></option>
                            ...
                            <div class="item data">
                                ...
                                <span>
                                    <input class="item-inputText date-piker" type="text" id="birthday" name="birthday" autocomplete="off">
                                    <picture>
                        ...
                        <div class="modal-row">
                            <div class="item selects">
                                ...
                                <select id="company_id" name="company_id" class="js-example-responsive2 my-select2" autocomplete="off">
                                    <option></option>
                            ...
                            <div class="item selects">
                                ...
                                <select id="status_id" name="status_id" class="js-example-responsive2 my-select2" autocomplete="off">
                                    <option></option>
                            ...
                            <div class="item data">
                                ...
                                <span>
                                    <input class="item-inputText date-piker" type="text" id="active_until" name="active_until" autocomplete="off">
                                    <picture>
                                        <source srcset="{{ asset('img/icon/calendar.svg') }}" type="image/webp">
                                        <img src="{{ asset('img/icon/calendar.svg') }}" alt="">
                                    </picture>
                        ...
                        <div class="modal-row">
                            <div class="item w100">
                                ...
                                <div class="item-inputText-wrapper">
                                    <textarea class="item-inputText" id="comment" name="comment" rows="2" autocomplete="off"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-row files">
                            <div class="item photo-loader">
                                ...
                                <div class="photo-info-list-wrapper">
                                    <ul class="photo-info-list">
                                        <li class="photo-info-btn-wrapper">
                                            <label class="photo-info-btn" for="photo">
                                                <input type="file" id="photo" name="photo" accept="image/png, image/jpg, image/jpeg, image/webp">
                                    ...
                                    <div class="photo-preview" id="photo-preview" style="display: none;">
                                        <img src="" alt="Preview" style="max-width: 100px; max-height: 100px; margin-top: 10px;">
                                        <button type="button" class="btn btn-sm btn-outline-danger ms-2" id="remove-photo">X</button>
                                    </div>
                            ...
                            <div class="item-row">
                                <div class="item w50">
                                    ...
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" id="passport" name="passport" type="text" autocomplete="off" placeholder="АА123456">
                                    </div>
                                </div>
                                <div class="item w50">
                                    <label for="inn">ИНН</label>
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" id="inn" name="inn" type="text" autocomplete="off" placeholder="1234567890">
                                    </div>
                                </div>
                            </div>
                        </div>
