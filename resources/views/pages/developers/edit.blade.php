    ...
    <div class="create-header">
        <div class="create-header-left">
            ...
            <h2 class="create-header-title">
                <span id="developer-id">ID: {{ $developer->id }} | {{ $developer->name }}</span>
            </h2>
        </div>
        <div class="create-header-right">
            <div class="create-header-add">
                Добавлено:
                <span id="created-at">{{ $developer->created_at?->format('d.m.Y') }}</span>
            </div>
            <div class="create-header-update">
                Обновлено:
                <span id="updated-at">{{ $developer->updated_at?->format('d.m.Y') }}</span>
            </div>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="create">
        ...
        <form id="developer-form" action="{{ route('developers.update', $developer) }}" method="POST"
            ...
            <div class="create-filter">
                ...
                <div class="create-filter-wrapper">
                    <div class="create-filter-left">
                                        ...
                                        <div class="tab-content-right">
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <input class="item-inputText" type="text" data-input-lang="ua"
                                                        id="name_ua" name="name_ua" autocomplete="off"
                                                        value="{{ old('name_ua', $developer->name_translations['ua'] ?? '') }}"
                                    ...
                                    <div class="tab-pane fade show active" id="ru-tab-pane-name" role="tabpanel"
                                        ...
                                        <div class="tab-content-right">
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <input class="item-inputText" type="text" data-input-lang="ru"
                                                        id="name_ru" name="name_ru" autocomplete="off"
                                                        value="{{ old('name_ru', $developer->name_translations['ru'] ?? $developer->name) }}"
                                    ...
                                    <div class="tab-pane fade" id="en-tab-pane-name" role="tabpanel"
                                        ...
                                        <div class="tab-content-right">
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <input class="item-inputText" type="text" data-input-lang="en"
                                                        id="name_en" name="name_en" autocomplete="off"
                                                        value="{{ old('name_en', $developer->name_translations['en'] ?? '') }}"
                                    ...
                                    <div class="tab-pane fade" id="ua-tab-pane-about" role="tabpanel"
                                        ...
                                        <div class="tab-content-right">
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <textarea class="item-textareaText" data-input-lang="ua"
                                                        id="description_ua" name="description_ua" autocomplete="off"
                                                        placeholder="Введіть текст">{{ old('description_ua', $developer->description_translations['ua'] ?? '') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade show active" id="ru-tab-pane-about" role="tabpanel"
                                        ...
                                        <div class="tab-content-right">
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <textarea class="item-textareaText" data-input-lang="ru"
                                                        id="description_ru" name="description_ru" autocomplete="off"
                                                        placeholder="Введите текст">{{ old('description_ru', $developer->description_translations['ru'] ?? $developer->description) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="en-tab-pane-about" role="tabpanel"
                                        ...
                                        <div class="tab-content-right">
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <textarea class="item-textareaText" data-input-lang="en"
                                                        id="description_en" name="description_en" autocomplete="off"
                                                        placeholder="Enter text">{{ old('description_en', $developer->description_translations['en'] ?? '') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="year_founded" name="year_founded" type="text"
                                        value="{{ old('year_founded', $developer->year_founded) }}" autocomplete="off"
                                        placeholder="год">
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="materials_url" name="materials_url" type="url"
                                        value="{{ old('materials_url', $developer->website) }}" autocomplete="off"
                                        placeholder="https://linkname.com">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item locations-block">
                            ...
                            <div class="locations-container" id="locations-container">
                                @forelse($developer->locations as $index => $location)
                                    <div class="location-item" data-location-index="{{ $index }}">
                                        <div class="location-search-wrapper">
                                            <select class="location-search" id="location-search-{{ $index }}"
                                                name="locations[{{ $index }}][location]">
                                                <option value="{{ $location->location_type . ':' . $location->location_id }}"
                                                    selected>
                                                    {{ $location->full_location_name ?: $location->location_name }}
                                                </option>
                                            </select>
                                            <button type="button" class="btn-remove-location" onclick="removeLocation(this)"
                                                @if($developer->locations->count() <= 1) style="display: none;" @endif>
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12.5 3.5L3.5 12.5M3.5 3.5L12.5 12.5" stroke="#EF4444"
                                ...
                                @empty
                                    <div class="location-item" data-location-index="0">
                                        <div class="location-search-wrapper">
                                            <select class="location-search" id="location-search-0"
                            ...
                            <button type="button" class="btn-add-location" id="btn-add-location" onclick="addLocation()">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8 3.5V12.5M3.5 8H12.5" stroke="#3585F5" stroke-width="1.5"
                    ...
                    <div class="create-filter-right">
                        ...
                        <div class="item">
                            <ul class="block-info @if($developer->contacts->count() > 0) d-none @endif"
                                id="add-contact-block">
                        ...
                        <div id="add-more-contact-btn" class="@if($developer->contacts->count() == 0) d-none @endif mb-3">
                        ...
                        <div class="loading-documents loading-logo">
                            <label for="logo">
                                ...
                                <span>
                                    ...
                                    <span class="text">Сменить лого</span>
                                </span>
                            </label>
                            <div class="filter-tags" data-render-document id="logo-preview">
                                @if($developer->logo_path)
                                    <div class="logo-preview-item">
                                        <img src="{{ Storage::url($developer->logo_path) }}" alt="Logo"
                                            style="max-width: 100px; max-height: 100px; border-radius: 8px;">
                                        <button type="button" class="btn-remove-logo" onclick="removeLogo()">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.5 3.5L3.5 12.5M3.5 3.5L12.5 12.5" stroke="#EF4444" stroke-width="2"
                                                    stroke-linecap="round" />
                                            </svg>
                                        </button>
                                    </div>
                        ...
                        <div class="item">
                            ...
                            <div class="item-inputText-wrapper">
                                <textarea class="item-textareaText" id="agent_notes" name="agent_notes" autocomplete="off"
                                    placeholder="Введите текст">{{ old('agent_notes', $developer->agent_notes) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-btnGroup">
                        <div class="create-btnGroup-wrapper">
                            <div class="create-btnGroup-left">
                                ...
                                <button class="btn btn-outline-danger" type="button" id="btn-delete-developer"
                                    onclick="if(confirm('Удалить девелопера?')) document.getElementById('delete-form').submit();">
                                    Удалить девелопера
                                </button>
                            </div>
        ...
        <form id="delete-form" action="{{ route('developers.destroy', $developer) }}" method="POST" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
    </div>
            ...
            <li class="block-info-item">
                <div class="info-title-wrapper">
                    ...
                    <button class="btn btn-edit-client" type="button" data-bs-toggle="modal"
                        data-bs-target="#add-contact-modal" data-edit-contact>
