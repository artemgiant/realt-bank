                                            ...
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <input class="item-inputText" type="text" data-input-lang="ua"
                                                        ...
                                                        value="{{ old('name_ua') }}" placeholder="Назва компанії">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <input class="item-inputText" type="text" data-input-lang="ru"
                                                        ...
                                                        value="{{ old('name_ru') }}" placeholder="Название компании">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="text_advertising-wrapper">
                                                ...
                                                <div class="item-inputText-wrapper">
                                                    <input class="item-inputText" type="text" data-input-lang="en"
                                                        ...
                                                        value="{{ old('name_en') }}" placeholder="The name of the company">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="year_founded" name="year_founded" type="text"
                                        value="{{ old('year_founded') }}" autocomplete="off" placeholder="год">
                                </div>
                            </div>
                            <div class="item">
                            ...
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="materials_url" name="materials_url" type="url"
                                        value="{{ old('materials_url') }}" autocomplete="off"
                        ...
                        <div class="item">
                            ...
                            <div class="item-inputText-wrapper">
                                <textarea class="item-textareaText" id="agent_notes" name="agent_notes" autocomplete="off"
                                    placeholder="Введите текст">{{ old('agent_notes') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
