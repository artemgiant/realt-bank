        ...
        <div class="modal-content">
            <form id="contact-modal-form" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="context" value="companies">
                    ...
                    <div class="modal-body-l">
                        ...
                        <div class="modal-row">
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="first-name-contact-modal" name="first_name" type="text" autocomplete="off" placeholder="Имя" required>
                                </div>
                            </div>
                            <div class="item">
                                <label for="last-name-contact-modal">Фамилия</label>
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="last-name-contact-modal" name="last_name" type="text" autocomplete="off" placeholder="Фамилия">
                                </div>
                            </div>
                            <div class="item">
                                <label for="middle-name-contact-modal">Отчество</label>
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="middle-name-contact-modal" name="middle_name" type="text" autocomplete="off" placeholder="Отчество">
                                </div>
                            </div>
                        </div>
                        <div class="modal-row">
                            <div class="item phone">
                                <div class="item" data-phone-item>
                                    ...
                                    <label for="tel-contact1-modal" class="green">Телефон <span class="text-danger">*</span></label>
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText tel-contact" id="tel-contact1-modal" name="phones[0][phone]" type="tel" autocomplete="off" required>
                            ...
                            <div class="item">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="email-contact-modal" name="email" type="email" autocomplete="off" placeholder="email@gmail.com">
                                </div>
                            </div>
                        ...
                        <div class="modal-row">
                            ...
                            <div class="item w75">
                                ...
                                <div class="item-inputText-wrapper">
                                    <input class="item-inputText" id="comment-contact-modal" name="comment" type="text" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="modal-row files">
                                    ...
                                    <ul class="photo-info-list">
                                        <li class="photo-info-btn-wrapper">
                                            <label class="photo-info-btn" for="loading-photo-contact-modal">
                                                <input type="file" id="loading-photo-contact-modal" name="photo" accept="image/png, image/jpg, image/jpeg, image/heic">
                            ...
                            <div class="item-row">
                                <div class="item w33">
                                    ...
                                    <input class="item-inputText" id="telegram-contact-modal" name="telegram" type="text" autocomplete="off" placeholder="@profilename">
                                </div>
                                <div class="item w33">
                                    <span><label class="item-label" for="viber-contact-modal">Viber</label></span>
                                    <input class="item-inputText" id="viber-contact-modal" name="viber" type="text" autocomplete="off" placeholder="@profilename">
                                </div>
                                <div class="item w33">
                                ...
                                <div class="item w33">
                                    <span><label class="item-label" for="instagram-contact-modal">Instagram</label></span>
                                    <input class="item-inputText" id="instagram-contact-modal" name="instagram" type="text" autocomplete="off" placeholder="@profilename">
                                </div>
                                <div class="item w33">
                                ...
                                <div class="item w50">
                                    ...
                                    <div class="item-inputText-wrapper">
                                        <input class="item-inputText" id="passport-contact-modal" name="passport" type="text" autocomplete="off" placeholder="АА123456">
                                    </div>
                                </div>
                                <div class="item w25">
                                ...
                                <div class="item w25 data">
                                    ...
                                    <span>
                                        <input class="item-inputText date-piker" type="text" id="birthday-contact-modal" name="birthday" autocomplete="off">
