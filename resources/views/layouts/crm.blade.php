...
<head>
    ...
    <!-- Бібліотеки CSS -->
    <link rel="stylesheet" href="{{ versioned_asset('css/lib/select2.min.css') }}">
    <link rel="stylesheet" href="{{ versioned_asset('css/lib/bootstrap.v5.3.3.min.css') }}">
    <link href="https://cdn.datatables.net/v/dt/dt-2.2.2/datatables.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ versioned_asset('css/lib/data-range-picker.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ versioned_asset('css/layouts/crm/sidebar.css') }}">
    <link rel="stylesheet" href="{{ versioned_asset('css/layouts/crm/crm-common.css') }}">
...
<body class="d-flex flex-column min-vh-100">
    ...
    <!-- Бібліотеки JS -->
    <script src="{{ versioned_asset('js/lib/popper.v2.11.8.min.js') }}"></script>
    <script src="{{ versioned_asset('js/lib/bootstrap.v5.3.3.min.js') }}"></script>
    <script src="{{ versioned_asset('js/lib/jquery.v3.7.1.min.js') }}"></script>
    <script src="{{ versioned_asset('js/lib/data-tables.min.js') }}"></script>
